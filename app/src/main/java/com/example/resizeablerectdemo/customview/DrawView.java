package com.example.resizeablerectdemo.customview;
...
import com.example.resizeablerectdemo.R;
import com.example.resizeablerectdemo.customview.ColorBall;
...
public class DrawView extends View {
    ...
    public DrawView(Context context) {
        ...
        colorballs.add(new ColorBall(context, R.mipmap.gray_circle, point1));
        colorballs.add(new ColorBall(context, R.mipmap.gray_circle, point2));
        colorballs.add(new ColorBall(context, R.mipmap.gray_circle, point3));
        colorballs.add(new ColorBall(context, R.mipmap.gray_circle, point4));
